    ...
    return (
      <div style={{ marginTop:"1rem", paddingTop:"1rem", borderTop:"1px solid rgba(255,255,255,.08)" }}>
        ...
        <div style={{ position:"relative", marginBottom:"0.625rem" }}>
          ...
          <span style={{ position:"absolute", right:"0.875rem", top:"50%", transform:"translateY(-50%)", fontSize:"0.8rem", color:"rgba(255,255,255,.35)", 
  fontFamily:"var(--font-display)", fontWeight:600 }}>kg</span>
        </div>
