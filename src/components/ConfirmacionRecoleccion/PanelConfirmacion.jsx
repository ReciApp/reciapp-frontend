  ...
  if (confirmado) {
    return (
      <motion.div initial={{ opacity:0, scale:.9 }} animate={{ opacity:1, scale:1 }}
        ...
        style={{ marginTop:"0.875rem", background:"rgba(132,204,22,.1)", border:"1px solid rgba(132,204,22,.3)", borderRadius:"var(--radius)", padding:"1.25rem", textAlign:"center" }}>
          ...
          <div style={{ display:"flex", flexDirection:"column", gap:"0.625rem", marginBottom:"0.875rem" }}>
            {evidencias.map((ev) => (
              <motion.div key={ev.id} initial={{ opacity:0, x:-10 }} animate={{ opacity:1, x:0 }}
                style={{ display:"flex", gap:"0.75rem", background:"rgba(255,255,255,.05)", border:"1px solid rgba(255,255,255,.09)", borderRadius:"var(--radius-sm)", padding:"0.75rem", alignItems:"center" }}>
            ...
            <div style={{ display:"flex", alignItems:"center", justifyContent:"space-between", background:"rgba(132,204,22,.08)", border:"1px solid rgba(132,204,22,.2)", borderRadius:"var(--radius-sm)", padding:"0.625rem 0.875rem" }}>
